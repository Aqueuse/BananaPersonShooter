...
namespace Gestion.BuildablesBehaviours {
    public class PlateformBehaviour : BuildableBehaviour {
        ...
        public override void GenerateSaveData() {
            ...
            ObjectsReference.Instance.gameData.currentMapData.AddBuildableToBuildableDictionnary(BuildableType.PLATEFORM, JsonConvert.SerializeObject(plateformData));
        }
