...
namespace Gestion.PlayerActions {
    public class Build : MonoBehaviour {
        ...
        [SerializeField] private BuildablePropertiesScriptableObject plateformBuildablePropertiesScriptableObject;
        ...
        public void ActivateGhostByScriptableObject(BuildablePropertiesScriptableObject buildablePropertiesScriptableObject) {
            _activeGhost = ghostsReference.GetGhostByBuildableType(buildablePropertiesScriptableObject.buildableType);
            _activeGhostClass = _activeGhost.GetComponent<Ghost>();
            activatedItemScriptableObject = buildablePropertiesScriptableObject;
        ...
        public void ActivatePlateformGhost() {
            ActivateGhostByScriptableObject(plateformBuildablePropertiesScriptableObject);
        }
        ...
        public void ValidateBuildable() {
            ...
            if (_activeGhostClass.GetGhostState() == GhostState.VALID) {
                ...
                var buildableGuid = Guid.NewGuid().ToString(); 
                
                _buildable.GetComponent<Tag>().gameObjectUuid = buildableGuid;
