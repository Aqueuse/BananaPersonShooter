...
namespace Input {
    public class SpaceTrafficControlCommandRoomPanelActions : InputActions {
        ...
        private void SwitchToCannonLeft(InputAction.CallbackContext context) {
            ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToLeftCannon();   
        }

        private void SwitchToCannonRight(InputAction.CallbackContext context) {
            ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToRightCannon();
        }
        
        private void SwitchToCannon1(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP01); }
        private void SwitchToCannon2(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP02); }
        private void SwitchToCannon3(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP03); }
        private void SwitchToCannon4(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP04); }
        private void SwitchToCannon5(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP05); }
        private void SwitchToCannon6(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP06); }
        private void SwitchToCannon7(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP07); }
        private void SwitchToCannon8(InputAction.CallbackContext context) { ObjectsReference.Instance.spaceTrafficControlMiniGameManager.SwitchToCannon(RegionType.MAP08); }

        private void RotateCannon(InputAction.CallbackContext context) {
            ObjectsReference.Instance.spaceTrafficControlMiniGameManager.MoveTarget(context.ReadValue<Vector2>().x, context.ReadValue<Vector2>().y);
        }

        private void Shoot(InputAction.CallbackContext context) {
            ObjectsReference.Instance.spaceTrafficControlMiniGameManager.Shoot();
        }
