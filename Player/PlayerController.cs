...
namespace Player {
    ...
    public class PlayerController : MonoBehaviour {
        ...
        public void RotateForward() {
            transform.rotation = new Quaternion(0, _mainCameraTransform.transform.rotation.y, 0,
                _mainCameraTransform.rotation.w);
        }
        ...
        public void PlayerMovement(InputAction.CallbackContext callbackContext) {
            ...
            _rawInputMovement =
                new Vector3(inputMovement.x, 0, inputMovement.y); // Y en input => Z pour le player (forward)
        }
